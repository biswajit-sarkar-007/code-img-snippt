...
export const initialCode = `function generatePassword() {
  const length = parseInt(prompt("Enter password length (min 6):"));
  if (length < 6 || isNaN(length)) return "Invalid length!";
